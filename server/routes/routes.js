...
router.get(`${BASE_URL}/favorites/:favorite_id`, customer.favorites.getItemById);
router.get(`${BASE_URL}/orders/:order_id`, customer.orders.getItemById);
...
// Remove Details
router.delete(`${BASE_URL}/favorites/:favorite_id`, customer.favorites.removeItem); // Remove item from favorites
router.delete(`${BASE_URL}/orders/:order_id`, customer.orders.removeItem); // Withdraw an Order
